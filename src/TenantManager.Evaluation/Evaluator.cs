...
public class Evaluator
{
    ...
    public Evaluator(string endpoint)
    {
        _endpoint = endpoint;
    }
    ...
    public async Task RunLiveAsync()
    {
        ...
        // Configure SettingsPersistence with the endpoint
        SettingsPersistence.SaveSettings(new AppSettings { IsAiEnabled = true, AiEndpoint = _endpoint, AiModelName = "evaluation-model" });
